...
const portfolioCompanies = [
  ...
  { name: "BusyX Chain", category: "Blockchain", desc: "A high-performance Layer 1 blockchain designed for scalable decentralized applications and enterprise solutions.", link: "#" },
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-5 py-2 mb-8">
              ...
              <span className="text-primary text-xs font-semibold tracking-wide uppercase">Portfolio</span>
            </div>
          </motion.div>
          <motion.h1
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-6">
                    <span className="text-xs font-semibold text-primary bg-primary/10 px-4 py-1.5 rounded-full border border-primary/20">
                      {company.category}
                    </span>
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">{company.desc}</p>
                </div>
